...
function Dashboard({ data, allPosts, wards, filters, setFilters, searchTerm, setSearchTerm }) {
  ...
  // Generate dropdown options from the master 'allPosts' list
      ...
      <div className="bg-white p-4 rounded-lg shadow-md">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 items-end">
          ...
          <div>
            ...
            <select id="ward" name="ward" value={filters.ward} onChange={handleFilterChange} className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
